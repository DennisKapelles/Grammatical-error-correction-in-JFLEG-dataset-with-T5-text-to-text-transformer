...
This repository contains the code, methodology, and results for a Master's thesis project focused on **automated grammatical error correction (GEC)** using **pretrained T5 (Text-to-Text Transfer Transformer)** model. The goal of the project is to fine-tune a pretrained model on grammatically erroneous text data and assess its effectiveness in correcting spelling, punctuation, and grammatical errors.
